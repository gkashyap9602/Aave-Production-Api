...
export const getBaseUrl = ()=>process.env.ENVIRONMENT !== 'development'?'https://apis-staging.nftbuilder.pro':'http://localhost:8800';
...
export const signToken = async (id: string, extras ={}, expiresIn = '48h') => {
    return new Promise((res, rej) => {
